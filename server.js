const envConfig = require("dotenv").config({path: './config.env'});
...
const handlePlayerLeaved = function (player) {
...
const handlePlayerDeath = function (msg) {
...
realtime.connection.once("connected", () => {
    ...
    gameRoom.presence.subscribe("leave", (player) => handlePlayerLeaved(player));
    deadPlayerCh.subscribe("dead-notif", (msg) => handlePlayerDeath(msg));
});
